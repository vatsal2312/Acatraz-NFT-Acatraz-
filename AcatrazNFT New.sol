...
contract AcatrazNFT is ERC721A, Ownable {
    ...
    mapping(address => uint) public rewardClaimedCount;
    ...
    function claimReward() public payable {
        require(rewardClaimedCount[msg.sender] < rewardCount, "Already claimed rewards!!");
        
        uint256 reward = 0;
        for(uint256 i = rewardClaimedCount[msg.sender] ; i < rewardCount ; i++) {
            reward = reward.add( rewardAmount[ i + 1 ] );
        }
